...
const About = () => {
  ...
  const technologies = [
    ...
    "Cloud Computing", "Mobile Development", "Web3", "IoT"
  ];
      ...
      <div className="max-w-7xl mx-auto px-6">
        <div className="text-center mb-16 animate-fade-in">
          ...
          <p className="text-xl text-muted-foreground max-w-3xl mx-auto leading-relaxed">
            젊은 에너지와 최신 트렌드를 바탕으로 혁신적인 기술 솔루션을 제공하며, 
            고객의 성공과 함께 성장하는 기술 파트너입니다.
          </p>
        </div>
          ...
          {values.map((value, index) => (
            ...
            >
              <CardContent className="p-6 text-center">
                <div className={`inline-flex items-center justify-center w-16 h-16 rounded-full bg-background/50 mb-4 group-hover:scale-110 transition-transform ${value.color}`}>
          ...
          <Card className="max-w-4xl mx-auto border-0 bg-gradient-to-br from-primary/5 to-accent-purple/5 backdrop-blur-sm">
            <CardContent className="p-8">
              ...
              <p className="text-lg text-muted-foreground leading-relaxed">
                ...
                <br />
                젊은 열정과 창의적 사고로 혁신적인 솔루션을 제공하여 
                디지털 시대의 새로운 가치를 창출합니다.
              </p>
            </CardContent>
          </Card>
        </div>
